...
async def list_tasks(
    ...
    async with pool.acquire() as conn:
        ...
        if search:
            ...
            param_idx += 1
            search_param3 = param_idx
            conditions.append(f"(t.task_no LIKE ${search_param1} OR t.title LIKE ${search_param2} OR t.confirmed_title LIKE ${search_param3})")
        ...
        for row in rows:
            ...
            # 标题优先使用文案确认标题
            item["title"] = item.get("confirmed_title") or item.get("title") or ""
